...
if(!$logout){
	...
	$login = "https://adapayu.top/auth/login";
	$r = post($login,$data);
	goto cek;
}
print "Login Sukses";
...
echo merah . "----------------------" . reset . "\n";
while(true){
	$faucet = "https://adapayu.top/faucet/currency/ada";
	$r = get($faucet);
	...
	$claim = "https://adapayu.top/faucet/verify/ada";
	$r = post($claim,$data);
